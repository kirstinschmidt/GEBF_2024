...
::: footer
[{{< ai open-access >}}]{.imp} Folien , [{{< ai open-data >}}]{.imp} Daten und [{{< ai open-materials >}}]{.imp} Code auf [{{< fa brands github >}}]{.imp} github verfügbar unter
:::
...
- es gibt m.W. nach 4 Studien, die sich explizit damit beschäftigen wie Vorabüberzeugungen den Umgang mit bildungswissenschaftlichen Informationen beeinflussen
  ...
  - Thomm und Kolleg:innen untersuchten zwar nicht ConfBias, sondern scientific impotence excuse. Hier geht es aber auch darum, inwieweit Überzeugungen beeinflussen, dass Aussagekraft von Wissenschaft abgelehnt wird
  - bedeutet konkret, dass man bei wissenschaftlichen Infos, die der Überzeugung widersprechen, angibt, dass das zugrundeliegende Thema grundsätzlich nicht wissenschaftlich untersucht werden kann
  - Studienergebnisse sprechen für einen Einfluss des scientific impotence excuse bei Lehrpersonen
...
- Futterleib und Kolleg:innen replizierten diese Studie in zwei weiteren experimentellen Studien, konnten aber nur in einer Studie die Ergebnisse von Thomm hinsichtlich Aussagekraft und Quellenauswahl replizieren
- die überraschende Überzeugungsanpassung zeigte sich allerdings in beiden Studien
...
3) als Ergänzung zum bisherigen Forschungsstand inwieweit Evidenz die Handlungstendenz updated, ein Indikator der etwas näher an dem tatsächlichen Handeln von Lehramtsstudierenden ist
